...
export const getOrderDetails = (id) => async (dispatch, getState) => {
    ...
    try {
        ...
        const { data } = await axios.get(`/api/order/${id}`, configUtil(token));
...
export const createSessionCheckoutWithStripe =
    ...
    async (dispatch, getState) => {
        ...
        try {
            const { data } = await axios.post(
                `/api/order/${orderId}/create-checkout-session`,
                {
                    line_items,
                    email,
                    payment_method_types,
...
export const listAllOrders =
    ...
    async (dispatch, getState) => {
        ...
        try {
            ...
            const { data } = await axios.get(
                `/api/orders?keyword=${keyword}&pageNumber=${pageNumber}&orderId=${orderId}`,
                configUtil(userInfo.token)
            );
...
export const deleteOrder = (id) => async (dispatch, getState) => {
    ...
    try {
        ...
        await axios.delete(`/api/order/${id}`, configUtil(userInfo.token));
        dispatch({
