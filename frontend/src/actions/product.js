...
export const getMenProduct =
    ...
    async (dispatch, getState) => {
        try {
            ...
            const { data } = await axios.get(
                `/api/products/men?sortBy=${sortBy}&currency=${currency}&category=${category}&color=${color}&priceFrom=${priceFrom}&priceTo=${priceTo}&pageNumber=${pageNumber}&gender=men`
            );
...
export const getWomenProduct =
    ...
    async (dispatch, getState) => {
        try {
            ...
            const { data } = await axios.get(
                `/api/products/women?sortBy=${sortBy}&currency=${currency}&category=${category}&color=${color}&priceFrom=${priceFrom}&priceTo=${priceTo}&pageNumber=${pageNumber}&gender=women`
            );
...
export const getKidsProduct =
    ...
    async (dispatch, getState) => {
        ...
        try {
            ...
            const { data } = await axios.get(
                `/axios/products/kids?sortBy=${sortBy}&currency=${currency}&category=${category}&color=${color}&priceFrom=${priceFrom}&priceTo=${priceTo}&pageNumber=${pageNumber}&gender=kids`
            );
...
export const getDiscountedProduct =
    ...
    async (dispatch, getState) => {
        ...
        try {
            ...
            const { data } = await axios.get(
                `/api/products/discount?sortBy=${sortBy}&currency=${currency}&category=${category}&color=${color}&priceFrom=${priceFrom}&priceTo=${priceTo}&pageNumber=${pageNumber}&discount=true`
            );
...
export const getProductsYouMayLike =
    (price, gender, pid) => async (dispatch, getState) => {
        try {
            ...
            const { data } = await axios.get(
                `/api/products-you-may-like?price=${price}&gender=${gender}&currency=${currency}&id=${pid}`
            );
